                ...
                <div class="col-lg-12 mt-5" style="text-align:center;">
                    <a class="course-link" href="/see-course/{{$popular_courses->course_id}}" style="text-align:left;">
                      <div class="card hvr-grow-shadow" style="width:90%;">
                        ...
                        <div class="card-body">
                          <h4 class="card-title course-title">{{str_limit($popular_courses->course_name,42)}}</h4><hr>
                          <h2 class="card-text">
  ...
  <div class="row">
    ...
    <div class="item">
      ...
      <div class="card hvr-grow-shadow" style="width:90%;">
        ...
        <div class="card-body">
          <h4 class="card-title course-title">{{str_limit($suggest_courses->course_name,42)}}</h4><hr>
          <h2 class="card-text">
