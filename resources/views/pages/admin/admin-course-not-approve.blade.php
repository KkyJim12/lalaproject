      ...
      <table class="table table-striped mt-3">
        ...
        <tbody>
          ...
          <tr>
                ...
                <div class="modal-dialog" role="document">
                  <div class="modal-content">
                    <div class="modal-header">
                      <h5 class="modal-title" id="exampleModalLabel">ใส่เหตุผลที่ปฏิเสธ</h5>
            ...
            <td>
              <a href="/admin-see-course-not-approve/{{$courses->course_id}}" class="btn btn-primary form-control">ดูข้อมูลเพิ่ม</a>
            </td>
          </tr>
          @endforeach
        </tbody>
